...
class Table
{
  ...
  /**
   * Build a Lum\DB\PDO\Schemata\Table object.
   *
   * You should never have to call this manually, it's called by the
   * Tables class. However, in case you need to override it, the definition
   * is included here.
   *
  ...
  /**
   * Return an array of TableVersion objects for each known tableVersion.
   */
  ...
  /**
   * Return an array of RowVersion objects for each known rowVersion.
   */
  ...
  /**
   * Does this table have a certain tag?
   */
  ...
  /**
   * Return any needed dependencies.
   */
  ...
  /**
   * Return any wanted dependencies.
   */
  ...
  /**
   * The new table that replaced this one.
   */
  ...
  /**
   * If this table replaces another one, return the one that is replaced.
   */
  ...
  /**
   * Return an associative array of dependencies, where the key is the
   * name of the table, and the value will be true if it's needed, or
   * false if it's wanted.
   */
  ...
  /**
   * Return the parent Tables object.
   */
...
/**
 * Internal class representing table configuration.
 */
...
/**
 * Internal abstract class representing a 'version'
 */
abstract class Version extends ConfigProps
{
  ...
  /**
   * Build a Version object. You'll never call this manually.
   */
  public function __construct ($def)
  {
    parent::__construct($def);
   ...
   *
   * @param mixed $checkVer Either another Version object, or a version string.
   * @param string $operator  See PHP version_compare() for valid operators.
   */
  ...
  /**
   * @param mixed $checkVer A Version oject or version string.
   * @return bool  True if this is not newer than the $checkVer.
   */
  ...
  /**
   * @param mixed $checkVer A Version oject or version string.
   * @return bool  True if this is older than the $checkVer.
   */
  ...
  /**
   * @param mixed $checkVer A Version oject or version string.
   * @return bool  True if this is newer than the $checkVer.
   */
  ...
  /**
   * @param mixed $checkVer A Version oject or version string.
   * @return bool  True if this is not older than the $checkVer.
   */
